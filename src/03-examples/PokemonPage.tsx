...
export const PokemonPage = () => {
    ...
    const { counter, increment, decrement,} = useCounter(); //hook para el contador
    const {pokemon, isLoading, formattedId} = usePokemon({id:counter}) //hook paara la informacion del pokemon
